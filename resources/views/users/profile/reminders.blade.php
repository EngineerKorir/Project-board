...
<main>
  <section id="notices-all">
    <div class="row">
      <div class="col checkbox1 hidden-xs-down">
      ...
      <div class="col status1"><span class="status"><button type="button" name="button" class="btn btn-secondary btn-sm">Active</button></span>
      </div>
    </div>

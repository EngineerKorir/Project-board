	...
	<div class="col-md-9">
		<main>
			<section id="notices-new">
						<form class="" action="{!! route('postLecturerNewNotice') !!}" method="POST" data-parsley-validate="" enctype="multipart/form-data">
                ...
                @endif
							...
							<div class="form-group {{ $errors->has('body') ? 'has-warning' : '' }}">
								...
								<textarea name="body" id="body-wyg" rows="14" class="form-control" required="">{{ old('body') }}</textarea>
